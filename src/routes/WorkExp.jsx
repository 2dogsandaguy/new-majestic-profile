  ...
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>Effectively managed diverse responsibilities, including parts ordering and inventory control.</li>
      ...
      <ul>
        <li>Provided expert service and repairs for material handling devices, showcasing strong problem-solving skills.</li>
      ...
      <ul>
        <li>Demonstrated proficiency in electrical panel wiring, machining, welding, and fabrication.</li>
